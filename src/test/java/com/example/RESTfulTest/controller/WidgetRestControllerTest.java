...
class WidgetRestControllerTest {
    ...
    //Solucion pauta PUT para modificar un elemento que se encuentra en la base de datos
    @Test
    ...
    //Solucion Pauta PUT para modificar un elemento que no se encuentra en la base de datos (not found)
    @Test
    ...
    //Solucion pauta GET para obtener un elemento por ID que se encuentra en la "base de datos"
    @Test
